            ...
            mapFragment.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap map) {
                    ...
                    PolylineOptions rectOptions = new PolylineOptions()
                            ...
                            .add(new LatLng(7.45, -122.0))  // North of the previous point, but at the same longitude
                            .add(new LatLng(7.45, -12.2))  // Same latitude, and 30km to the west
                            .add(new LatLng(37.35, -12.2))  // Same longitude, and 16km to the south
                            .add(new LatLng(37.35, -122.0)); // Closes the polyline.
// Get back the mutable Polyline

                    CircleOptions circleOptions = new CircleOptions()
                            .center(new LatLng(37.822, -98.328))
                            .radius(0); // In meters
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            circle.setRadius(circle.getRadius() + 550);
                        }
                    });*/
    ...
    */
    ...
    public void onMapLongClick(LatLng point) {
        ...
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (circle.getRadius() < 2800000) {
                    handler.postDelayed(this, 15);
                    circle.setRadius(circle.getRadius() + 1550);
                }
                else {
